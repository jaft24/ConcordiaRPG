 ...
 * @author Office Heros
 */
public class MusicArea2 extends javax.swing.JFrame {

    /**
     * Creates new form MusicArea2
     */
    public MusicArea2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(540, 430, 30, 50);

        jLabel3.setBackground(new java.awt.Color(255, 0, 0));
        jPanel1.add(jLabel3);
        jLabel3.setBounds(260, 0, 30, 50);
        jLabel3.getAccessibleContext().setAccessibleDescription("");

        jLabel4.setBackground(new java.awt.Color(0, 255, 0));
        jPanel1.add(jLabel4);
        jLabel4.setBounds(570, 440, 30, 30);

        jLabel5.setText("..");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(390, 40, 30, 50);

        jLabel6.setText("..");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(161, 36, 30, 50);

        jLabel7.setText("..");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(220, 490, 30, 50);

        jLabel8.setText("..");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(301, 210, 30, 50);

        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\jalet\\OneDrive\\Desktop\\Concordia RPG by Office Heroes\\CSC225 IMAGES\\MUSIC.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusicArea2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MusicArea2().setVisible(true);
            }
        });
    }
