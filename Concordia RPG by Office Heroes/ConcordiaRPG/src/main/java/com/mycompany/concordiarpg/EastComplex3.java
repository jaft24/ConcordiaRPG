 ...
 */
public class EastComplex3 extends javax.swing.JFrame {

    /**
     * Creates new form Office Hero
     */
    public EastComplex3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(10, 30, 30, 50);
        jPanel1.add(jLabel3);
        jLabel3.setBounds(0, 0, 0, 30);

        jLabel4.setText("jLabel4");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(110, 300, 30, 50);

        jLabel5.setText("jLabel5");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(400, 120, 30, 50);
        jLabel5.getAccessibleContext().setAccessibleDescription("");

        jLabel6.setText("jLabel6");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(411, 230, 30, 50);

        jLabel7.setText("jLabel7");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(510, 310, 30, 50);
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
       ...
       ass.setVisible(true);
           ...
           WelcomeCenter rm = new WelcomeCenter();
           rm.setVisible(true);
           dispose(); 
          }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EastComplex3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EastComplex3().setVisible(true);
            }
        });
    }
