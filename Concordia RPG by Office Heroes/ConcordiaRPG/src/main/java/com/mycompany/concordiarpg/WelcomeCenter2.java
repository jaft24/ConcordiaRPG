 ...
 */
public class WelcomeCenter2 extends javax.swing.JFrame {

    /**
     * Creates new form WelcomeCenter2
     */
    public WelcomeCenter2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(190, 50, 30, 50);

        jLabel3.setBackground(new java.awt.Color(255, 0, 0));
        jPanel1.add(jLabel3);
        jLabel3.setBounds(570, 550, 30, 50);

        jLabel4.setBackground(new java.awt.Color(51, 255, 0));
        jPanel1.add(jLabel4);
        jLabel4.setBounds(190, 0, 30, 40);
        jPanel1.add(jLabel6);
        jLabel6.setBounds(150, 240, 30, 50);
        jLabel6.getAccessibleContext().setAccessibleDescription("");

        jPanel1.add(jLabel7);
        jLabel7.setBounds(130, 50, 30, 50);
        jPanel1.add(jLabel8);
        jLabel8.setBounds(420, 276, 30, 50);
        jPanel1.add(jLabel9);
        jLabel9.setBounds(400, 476, 30, 50);

        jLabel5.setText("jLabel5");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(1, 410, 20, 40);
    ...
    private void formKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_formKeyPressed
       ...
       // to control the Niblet and other JLabels. 
        ...
        if (jLabel2.getLocation().x == jLabel4.getLocation().x && jLabel2.getLocation().y==jLabel4.getLocation().y ||
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WelcomeCenter2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WelcomeCenter2().setVisible(true);
            }
        });
    }
